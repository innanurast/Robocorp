...
#downloading file excel - fill data form input - export excel to pdf with html to pdf
@task
...
def fill_form_with_excel_data():
    ...
    #melakukan perulangan data input excel ke form input web
...
def export_as_pdf():
    ...
    toPdf = PDF()
    toPdf.html_to_pdf(sales_results_html, "output/sales_results.pdf")
