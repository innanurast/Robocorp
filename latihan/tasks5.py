...
EMPLOYEES_EXCEL_PATH = os.environ["D:/Bootcamp Berca/Robocorp/latihan/employees.xlsx"]
TRAININGS_EXCEL_PATH = os.environ["D:/Bootcamp Berca/Robocorp/latihan/trainings.xlsx"]
excel = Files()
tables = Tables()
